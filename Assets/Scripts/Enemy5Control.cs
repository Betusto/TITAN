...
public class Enemy5Control : MonoBehaviour //Script para el Movimiento del Enemigo
{
    ...
    void Start()
    {
        health = 10; //vida del enemigo
        speed = 1.4f;//marcar la velocidad
    ...
    void OnTriggerEnter2D(Collider2D col)
    {
        ...
        if (col.tag == "PlayerShipTag") //|| (col.tag == "PlayerBulletTag"))
        {
            ...
            //añade 300 puntos al marcador (score)
