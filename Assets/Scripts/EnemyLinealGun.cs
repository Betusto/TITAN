...
public class EnemyLinealGun : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Invoke("FireEnemyBullet", Random.Range(1f, 10f));
        //InvokeOther();
        //StartCoroutine("InvokeOneMore");
        StartCoroutine("InvokeTwoMore");
    }
    ...
    void Update()
    {
        //Invoke("FireEnemyBullet", 1f); //da un efecto bien padre pero esta muy op 
    }
